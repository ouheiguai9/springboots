    ...
    Feedback.prototype = {
        successMsg: function (content, onAfterClose) {
            var config = {
                ...
                , shadeClose: true
                , time: 3000
                , content: '<i class="layui-icon layui-icon-ok-circle f-txt-light-green"></i>'
                    + '<span class="layui-text layui-elip f-txt-light-green">' + (content || '操作成功') + '</span>'
            };
        ...
        , failMsg: function (detail, onAfterClose) {
            ...
            var config = {
                skin: 's-layer-feedback-error'
                , closeBtn: 0
                , title: false
                , move: false
                , btn: ['<i class="layui-icon layui-icon-close f-txt-gray"></i>']
                , time: 0
                , content: '<i class="layui-icon layui-icon-about f-txt-red"></i>'
                    + '<span class="layui-text f-txt-black">操作失败</span>'
